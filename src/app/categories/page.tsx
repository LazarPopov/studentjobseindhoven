...
export const metadata: Metadata = {
  title: "Browse Job Categories in Eindhoven | Student Jobs Rotterdam",
  description:
  ...
  alternates: { canonical: "https://studentjobsEindhoven.nl/categories/${slug}" },
  openGraph: {
    ...
    url: "https://studentjobsEindhoven.nl/categories",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              itemListElement: CATEGORIES.map((c, i) => ({
                ...
                position: i + 1,
                name: c.label,
                url: `https://studentjobsEindhoven.nl/categories/${c.key}`,
              })),
            }),
          }}
        />

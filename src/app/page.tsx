// src/app/page.tsx (Next.js App Router) — Eindhoven homepage (SEO-ready, rank-and-rent)
...
export const metadata: Metadata = {
  title: "Student Jobs in Eindhoven (2026) | Part-Time & English-Friendly Work",
  description:
    "Find student jobs in Eindhoven: hospitality, logistics, retail, tutoring and more. English-friendly roles, flexible hours, updated daily.",
  alternates: { canonical: "https://studentjobseindhoven.nl/" },
  openGraph: {
    title: "Student Jobs in Eindhoven (2026)",
    description:
      "Part-time & English-friendly work for students in Eindhoven. Updated daily.",
    url: "https://studentjobseindhoven.nl/",
...
export default function Page() {
  ...
  const blogPosts = [
    {
      ...
      title:
        "Studenten bijbaan Eindhoven (2026) – Goed betaald, Engelstalig & weekend",
      excerpt:
  ...
  const faqs = [
    {
      q: "Can non-EU students work in Eindhoven?",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target:
                "https://studentjobseindhoven.nl/jobs?q={search_term_string}",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: featuredJobs.map((job: any, index: number) => ({
              ...
              url: job.externalUrl
                ? job.externalUrl
                : `https://studentjobseindhoven.nl/jobs/${job.slug}`,
              name: job.title,
            })),
          }),
        }}
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl md:text-5xl font-semibold text-white">
                  Student Jobs in Eindhoven (2026)
                </h1>
    ...
    <section className="px-6 py-4 bg-gray-50">
        ...
        <div className="mx-auto max-w-6xl grid gap-8 md:grid-cols-2">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold">
              Why Eindhoven works for students
            </h2>
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-6xl rounded-2xl border p-6 md:p-10 bg-white">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold">
                Are you a business? Hire students in Eindhoven
              </h2>
            ...
            <div className="rounded-xl border p-5">
              ...
              <p className="mt-2 text-gray-700">
                ...
                categories, and targeted candidates via our Eindhoven-only list.
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-3xl rounded-2xl border p-6 md:p-10">
          <h2 className="text-2xl md:text-3xl font-semibold">
            Get weekly student jobs in your inbox (Eindhoven)
          </h2>
          <p className="mt-2 text-gray-700">
          ...
          >
            ...
            <input
              ...
              required
            />
            <input type="hidden" name="city" value="Eindhoven" />
            <button
          ...
          <div className="rounded-2xl border bg-white p-5 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-700 mt-1">
                We collaborate with SEO, community, and hiring partners in Eindhoven.
              </p>
            </div>
            <Link
              href="/partners"
